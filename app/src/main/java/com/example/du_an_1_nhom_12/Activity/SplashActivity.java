...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer countDownTimer = new CountDownTimer(2000,1000) {
            ...
            public void onFinish() {
                if (lang_selected){
                    //dc chon
                    Intent intent = new Intent(SplashActivity.this, MainViewPager.class);
                    startActivity(intent);
                    finishAffinity();
                    if (started) {
                        //dc chon
                        Intent intent0 = new Intent(SplashActivity.this, PermissionActivity.class);
                        intent0.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(intent0);
                        finishAffinity();
                        if (permission){
                            //dc chon
                            Intent intent1 = new Intent(SplashActivity.this, ManageFileActivity.class);
                            intent1.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                            startActivity(intent1);
                            finishAffinity();
                        }else {
                            //chua dc chon
                            Intent intent2 = new Intent(SplashActivity.this,PermissionActivity.class);
                        ...
                        //chua dc chon
                        Intent intent3 = new Intent(SplashActivity.this, MainViewPager.class);
                    ...
                    //chua dc chon
                    Intent intent4 = new Intent(SplashActivity.this, LanguageActivity.class);
    ...
    public void showNotification(){
        ...
        Notification customNotification = new NotificationCompat.Builder(SplashActivity.this, NotifyConfig.CHANEL_ID)
